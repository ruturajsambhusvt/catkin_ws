...
set(MSG_I_FLAGS "-Irosserial_mbed:/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg")
...
get_filename_component(_filename "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg/Adc.msg" NAME_WE)
add_custom_target(_rosserial_mbed_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosserial_mbed" "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg/Adc.msg" ""
)

get_filename_component(_filename "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/srv/Test.srv" NAME_WE)
add_custom_target(_rosserial_mbed_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosserial_mbed" "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/srv/Test.srv" ""
)
...
_generate_msg_cpp(rosserial_mbed
  "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg/Adc.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(rosserial_mbed
  "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/srv/Test.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rosserial_mbed
)
...
### Generating Messages
_generate_msg_eus(rosserial_mbed
  "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg/Adc.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rosserial_mbed
)

### Generating Services
_generate_srv_eus(rosserial_mbed
  "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/srv/Test.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rosserial_mbed
...
### Generating Module File
_generate_module_eus(rosserial_mbed
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rosserial_mbed
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(rosserial_mbed_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(rosserial_mbed_generate_messages rosserial_mbed_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg/Adc.msg" NAME_WE)
add_dependencies(rosserial_mbed_generate_messages_eus _rosserial_mbed_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/srv/Test.srv" NAME_WE)
add_dependencies(rosserial_mbed_generate_messages_eus _rosserial_mbed_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(rosserial_mbed_geneus)
add_dependencies(rosserial_mbed_geneus rosserial_mbed_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS rosserial_mbed_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(rosserial_mbed
  "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg/Adc.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rosserial_mbed
)

### Generating Services
_generate_srv_nodejs(rosserial_mbed
  "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/srv/Test.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rosserial_mbed
...
### Generating Module File
_generate_module_nodejs(rosserial_mbed
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rosserial_mbed
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(rosserial_mbed_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(rosserial_mbed_generate_messages rosserial_mbed_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/msg/Adc.msg" NAME_WE)
add_dependencies(rosserial_mbed_generate_messages_nodejs _rosserial_mbed_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/trec/catkin_ws/src/rosserial/rosserial_mbed/srv/Test.srv" NAME_WE)
add_dependencies(rosserial_mbed_generate_messages_nodejs _rosserial_mbed_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(rosserial_mbed_gennodejs)
add_dependencies(rosserial_mbed_gennodejs rosserial_mbed_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS rosserial_mbed_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rosserial_mbed)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rosserial_mbed
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rosserial_mbed)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rosserial_mbed
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosserial_mbed)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosserial_mbed\")")
  # install generated code
  install(
