...
namespace gazebo_ros
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(PhysicsConfig &config, const PhysicsConfig &max, const PhysicsConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const PhysicsConfig &config1, const PhysicsConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, PhysicsConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const PhysicsConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, PhysicsConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const PhysicsConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const PhysicsConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, PhysicsConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
