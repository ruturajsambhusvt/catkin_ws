...
namespace gazebo_plugins
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(GazeboRosOpenniKinectConfig &config, const GazeboRosOpenniKinectConfig &max, const GazeboRosOpenniKinectConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const GazeboRosOpenniKinectConfig &config1, const GazeboRosOpenniKinectConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, GazeboRosOpenniKinectConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const GazeboRosOpenniKinectConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, GazeboRosOpenniKinectConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const GazeboRosOpenniKinectConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const GazeboRosOpenniKinectConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, GazeboRosOpenniKinectConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
