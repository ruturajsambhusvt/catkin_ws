...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_ros_control_SOURCE_PREFIX /home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_ros_control)
  set(gazebo_ros_control_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(gazebo_ros_control_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT "/home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_ros_control/include " STREQUAL " ")
  set(gazebo_ros_control_INCLUDE_DIRS "")
  set(_include_dirs "/home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_ros_control/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_ros_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gazebo_ros_control_NUM_DUMMY_TARGETS)
      set(gazebo_ros_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gazebo_ros_control::wrapped-linker-option${gazebo_ros_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gazebo_ros_control_NUM_DUMMY_TARGETS "${gazebo_ros_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gazebo_ros_control::wrapped-linker-option${gazebo_ros_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gazebo_ros_control_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(gazebo_ros_control_EXPORTED_TARGETS ${${gazebo_ros_control_dep}_EXPORTED_TARGETS})
endforeach()
