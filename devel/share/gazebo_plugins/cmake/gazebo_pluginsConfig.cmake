...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_plugins_SOURCE_PREFIX /home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_plugins)
  set(gazebo_plugins_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(gazebo_plugins_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT "/home/trec/catkin_ws/devel/include;/home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_plugins/include " STREQUAL " ")
  set(gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/trec/catkin_ws/devel/include;/home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_plugins/include")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gazebo_plugins_NUM_DUMMY_TARGETS)
      set(gazebo_plugins_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gazebo_plugins::wrapped-linker-option${gazebo_plugins_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gazebo_plugins_NUM_DUMMY_TARGETS "${gazebo_plugins_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gazebo_plugins::wrapped-linker-option${gazebo_plugins_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gazebo_plugins_LIBRARIES "${interface_target_name}")
...
set(depends "message_runtime;gazebo_msgs;roscpp;rospy;nodelet;angles;std_srvs;geometry_msgs;sensor_msgs;nav_msgs;urdf;tf;tf2_ros;dynamic_reconfigure;rosgraph_msgs;trajectory_msgs;image_transport;rosconsole;camera_info_manager;std_msgs;visualization_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gazebo_plugins_dep}_FOUND)
      find_package(${gazebo_plugins_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gazebo_plugins_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(gazebo_plugins_EXPORTED_TARGETS ${${gazebo_plugins_dep}_EXPORTED_TARGETS})
endforeach()
