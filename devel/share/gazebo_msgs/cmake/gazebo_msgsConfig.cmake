...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_msgs_SOURCE_PREFIX /home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_msgs)
  set(gazebo_msgs_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(gazebo_msgs_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT "/home/trec/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gazebo_msgs_NUM_DUMMY_TARGETS)
      set(gazebo_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gazebo_msgs::wrapped-linker-option${gazebo_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gazebo_msgs_NUM_DUMMY_TARGETS "${gazebo_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gazebo_msgs::wrapped-linker-option${gazebo_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gazebo_msgs_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(gazebo_msgs_EXPORTED_TARGETS ${${gazebo_msgs_dep}_EXPORTED_TARGETS})
endforeach()
