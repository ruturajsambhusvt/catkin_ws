...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/trec/catkin_ws/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/ros_control/controller_manager_tests/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT controller_manager_tests_NUM_DUMMY_TARGETS)
      set(controller_manager_tests_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::controller_manager_tests::wrapped-linker-option${controller_manager_tests_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR controller_manager_tests_NUM_DUMMY_TARGETS "${controller_manager_tests_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::controller_manager_tests::wrapped-linker-option${controller_manager_tests_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND controller_manager_tests_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(controller_manager_tests_EXPORTED_TARGETS ${${controller_manager_tests_dep}_EXPORTED_TARGETS})
endforeach()
