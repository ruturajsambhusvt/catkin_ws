...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX /home/trec/catkin_ws/src/ros_control/controller_manager_msgs)
  set(controller_manager_msgs_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(controller_manager_msgs_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT "/home/trec/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/ros_control/controller_manager_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT controller_manager_msgs_NUM_DUMMY_TARGETS)
      set(controller_manager_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::controller_manager_msgs::wrapped-linker-option${controller_manager_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR controller_manager_msgs_NUM_DUMMY_TARGETS "${controller_manager_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::controller_manager_msgs::wrapped-linker-option${controller_manager_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND controller_manager_msgs_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(controller_manager_msgs_EXPORTED_TARGETS ${${controller_manager_msgs_dep}_EXPORTED_TARGETS})
endforeach()
