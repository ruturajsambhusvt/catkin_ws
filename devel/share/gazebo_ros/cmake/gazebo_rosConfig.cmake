...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_ros)
  set(gazebo_ros_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(gazebo_ros_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT "/home/trec/catkin_ws/devel/include;/usr/include " STREQUAL " ")
  set(gazebo_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/trec/catkin_ws/devel/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/gazebo_ros_pkgs/gazebo_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(gazebo_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gazebo_ros_api_plugin;gazebo_ros_paths_plugin;/usr/lib/libtinyxml.so")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gazebo_ros_NUM_DUMMY_TARGETS)
      set(gazebo_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gazebo_ros::wrapped-linker-option${gazebo_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gazebo_ros_NUM_DUMMY_TARGETS "${gazebo_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gazebo_ros::wrapped-linker-option${gazebo_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gazebo_ros_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(gazebo_ros_EXPORTED_TARGETS ${${gazebo_ros_dep}_EXPORTED_TARGETS})
endforeach()
