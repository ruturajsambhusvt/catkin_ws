...
if("TRUE" STREQUAL "TRUE")
  set(combined_robot_hw_tests_SOURCE_PREFIX /home/trec/catkin_ws/src/ros_control/combined_robot_hw_tests)
  set(combined_robot_hw_tests_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(combined_robot_hw_tests_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'combined_robot_hw_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/ros_control/combined_robot_hw_tests/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT combined_robot_hw_tests_NUM_DUMMY_TARGETS)
      set(combined_robot_hw_tests_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::combined_robot_hw_tests::wrapped-linker-option${combined_robot_hw_tests_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR combined_robot_hw_tests_NUM_DUMMY_TARGETS "${combined_robot_hw_tests_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::combined_robot_hw_tests::wrapped-linker-option${combined_robot_hw_tests_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND combined_robot_hw_tests_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(combined_robot_hw_tests_EXPORTED_TARGETS ${${combined_robot_hw_tests_dep}_EXPORTED_TARGETS})
endforeach()
