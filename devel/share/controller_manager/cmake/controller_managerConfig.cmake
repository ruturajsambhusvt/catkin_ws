...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/trec/catkin_ws/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(controller_manager_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT "/home/trec/catkin_ws/src/ros_control/controller_manager/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/trec/catkin_ws/src/ros_control/controller_manager/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/ros_control/controller_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT controller_manager_NUM_DUMMY_TARGETS)
      set(controller_manager_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::controller_manager::wrapped-linker-option${controller_manager_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR controller_manager_NUM_DUMMY_TARGETS "${controller_manager_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::controller_manager::wrapped-linker-option${controller_manager_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND controller_manager_LIBRARIES "${interface_target_name}")
...
set(depends "controller_interface;controller_manager_msgs;hardware_interface;pluginlib;roscpp")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(controller_manager_EXPORTED_TARGETS ${${controller_manager_dep}_EXPORTED_TARGETS})
endforeach()
