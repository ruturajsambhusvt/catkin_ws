...
if("TRUE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX /home/trec/catkin_ws/src/ros_control/joint_limits_interface)
  set(joint_limits_interface_DEVEL_PREFIX /home/trec/catkin_ws/devel)
  ...
  set(joint_limits_interface_INSTALL_PREFIX /home/trec/catkin_ws/install)
...
if(NOT "/home/trec/catkin_ws/src/ros_control/joint_limits_interface/include " STREQUAL " ")
  set(joint_limits_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/trec/catkin_ws/src/ros_control/joint_limits_interface/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trec/catkin_ws/src/ros_control/joint_limits_interface/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT joint_limits_interface_NUM_DUMMY_TARGETS)
      set(joint_limits_interface_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::joint_limits_interface::wrapped-linker-option${joint_limits_interface_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR joint_limits_interface_NUM_DUMMY_TARGETS "${joint_limits_interface_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::joint_limits_interface::wrapped-linker-option${joint_limits_interface_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND joint_limits_interface_LIBRARIES "${interface_target_name}")
...
set(depends "hardware_interface;roscpp;urdf")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(joint_limits_interface_EXPORTED_TARGETS ${${joint_limits_interface_dep}_EXPORTED_TARGETS})
endforeach()
